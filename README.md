...
- Update the database configuration in the "db_connection.php" file in the project folder /src/components/db to match your MySQL database settings (database name, username, password, and host).
- Open a web browser and go to http://localhost/ to access the project. Replace <repository> with the name of the repository folder in the "htdocs" folder.
